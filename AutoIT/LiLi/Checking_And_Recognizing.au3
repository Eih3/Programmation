	...
	Else
		...
		Else
			...
			ElseIf StringInStr($shortname, "buntu") Then
				...
				if StringInStr($shortname, "13.04") OR StringInStr($shortname, "raring") OR StringInStr($shortname, "ringtail") Then
					$ubuntu_version = "13.04"
				Elseif StringInStr($shortname, "12.10") OR StringInStr($shortname, "quantal") OR StringInStr($shortname, "quetzal") Then
					$ubuntu_version = "12.10"
				Elseif StringInStr($shortname, "12.04") OR StringInStr($shortname, "precise") OR StringInStr($shortname, "pangolin") Then
					$ubuntu_version = "12.04"
				Elseif StringInStr($shortname, "11.10") OR StringInStr($shortname, "oneiric") OR StringInStr($shortname, "ocelot") Then
